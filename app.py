...
app = Flask(__name__)
app.secret_key = os.environ.get("SECRET_KEY", "remedial-monitoring-system-demo-secret")

# Restores PROJECTS/TASKS/etc. from the database on startup, then keeps
# saving them after every request that could have changed something — see
# persistence.py for how that works and what it doesn't cover.
